...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || 'يامي',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭AYANOKOJI¹¹ꫂ;YAMI MD bot;https://www.linkpicture.com/q/rgnk.jpg' : process.env.AUDIO_DATA,
